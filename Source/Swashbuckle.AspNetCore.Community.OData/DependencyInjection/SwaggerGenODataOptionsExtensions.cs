namespace Swashbuckle.AspNetCore.Community.OData.DependencyInjection
{
    ...
    public static class SwaggerGenODataOptionsExtensions
    {
        ...
        /// <param name="odataRoute">The OData route this information is associated with.</param>
        ...
        public static void SwaggerDoc(
            ...
            string name,
            string odataRoute,
            OpenApiInfo info) => swaggerGenODataOptions.SwaggerGeneratorODataOptions.SwaggerDocs.Add(name, (odataRoute, info));
    }
}
